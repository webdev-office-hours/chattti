  ...
  <div class="container mx-auto px-4">
    ...
    <section class="p-4">
      <div class="flex flex-wrap">
        ...
        <!-- Left Header Content -->
        <div class="md:w-1/2 py-4 md:px-10 mb-4 md:mb-0 text-center"><img class="mx-auto mb-3" src="placeholders/icons/shield.svg" alt="">
        ...
        <div class="md:w-1/2 py-4 md:px-10 mb-4 md:mb-0 md:border-l"><img class="mx-auto mb-3" src="placeholders/icons/cloud-tools.svg" alt="">
            <h2>Chattty!</h2>
    ...
    <br />
    <input class="w-3/4 bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 appearance-none leading-normal" type="text" placeholder="Enter Messsage" v-model="newMessage" />
